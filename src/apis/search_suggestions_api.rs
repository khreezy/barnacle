...
pub trait SearchSuggestionsApi: Send + Sync {
    ...
    ) -> Result<models::SearchSuggestionsMultiResourceDataDocument, Error<GetSearchSuggestionsError>>;
...
impl SearchSuggestionsApi for SearchSuggestionsApiClient {
    ...
    ) -> Result<models::SearchSuggestionsMultiResourceDataDocument, Error<GetSearchSuggestionsError>>
    {
        ...
        let local_var_uri_str = format!("{}/searchSuggestions", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SearchSuggestionsMultiResourceDataDocument`"))),
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::SearchSuggestionsMultiResourceDataDocument`")))),
            }
        } else {
            let local_var_entity: Option<GetSearchSuggestionsError> =
...
/// struct for typed errors of method [`SearchSuggestionsApi::get_search_suggestions`]
