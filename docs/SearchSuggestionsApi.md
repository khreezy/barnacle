...
------------- | ------------- | -------------
[**get_search_suggestions**](SearchSuggestionsApi.md#get_search_suggestions) | **GET** /searchSuggestions | Get multiple searchSuggestions.
...
> models::SearchSuggestionsMultiResourceDataDocument get_search_suggestions(page_cursor, explicit_filter, country_code, include, filter_left_square_bracket_query_right_square_bracket)
Get multiple searchSuggestions.

Retrieves multiple searchSuggestions by available filters.
...
[**models::SearchSuggestionsMultiResourceDataDocument**](SearchSuggestions_Multi_Resource_Data_Document.md)
